...
public class DataGen implements DataGeneratorEntrypoint
{
    ...
    public void onInitializeDataGenerator(FabricDataGenerator fabricDataGenerator)
    {
        ...
        pack.addProvider((dataOutput, registriesFuture1) -> {
            return new ChickenVariantProvider(dataOutput, registriesFuture1);
        });
...
//            provider.add("item.chickens.chicken.name", "Chickens Mod Chicken", ModuleType.COMMON);
            ...
            provider.add("entity.chickens.chicken.name", "%s Chicken", ModuleType.COMMON);
            provider.add("entity.chickens.rooster.name", "%s Rooster", ModuleType.COMMON);

            provider.add("item.chickens.chicken.name", "%s Chicken", ModuleType.COMMON);
            provider.add("item.chickens.rooster.name", "%s Rooster", ModuleType.COMMON);
